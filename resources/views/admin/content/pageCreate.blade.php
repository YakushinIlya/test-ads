<form method="post" action="{{route('adminPageCreate')}}" accept="application/json">
    @csrf
    ...
    <div class="form-group">
        ...
        <input type="text" name="head" class="form-control" id="head" placeholder="Введите заголовок страницы" value="{{old('head')}}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <textarea name="body" id="body" rows="5" class="form-control" placeholder="Введите краткую информацию страницы" value="{{old('body')}}"></textarea>
    </div>
